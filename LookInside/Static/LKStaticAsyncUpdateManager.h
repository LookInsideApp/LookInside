...
/// 由 owner 注入的 inspectable app(weak)。Phase F 起所有 RPC 路径完全依赖该字段,
/// 不再有兜底全局。owner(LKStaticWindowController._applyHierarchyInfo:forApp:keepState:)
/// 在新 hierarchy 到达时刷新该字段。
