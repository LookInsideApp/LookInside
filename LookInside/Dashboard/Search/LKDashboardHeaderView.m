...
- (void)handleAddCustomAttr {
    [LKHelper showDisabledExternalLinkAlertWithMessage:NSLocalizedString(@"Legacy custom property guides are disabled in this community build. See the repository README instead.", nil)];
}
